...
export const IngredientSearch: React.FC = () => {
    ...
    return (
        <main className="mx-auto w-full max-w-4xl pb-20" aria-labelledby="ingredient-search-title">
            <div
                className="px-5 py-10 mx-auto flex w-full flex-col gap-8 rounded-2xl
                    border border-stone-900/10 bg-white/70 shadow-[0_8px_28px_rgba(28,25,23,0.08)]"
            >
                <PageHeading
