      ...
      <g>
        <g>
          <path
            ...
            d="M59.05,32.61s-4.74-3.38-11.09.41c-6.36,3.79-13.93,17.45-20.56,29.9-6.63,12.45-15.02,25.16-12.85,28.95s8.12,0,14.75-4.74c6.63-4.74,27.6-27.73,32.33-33.28,4.74-5.55,6.49-11.23,5.82-14.48-.68-3.25-1.62-2.98-1.62-2.98,0,0-6.49,4.46-7.17,2.3s.41-6.09.41-6.09Z"
          />
          <path
          ...
          <path
            className="fill-[#4a2d2d]"
            d="M30.2,72.36c1.16,3.13,4.72,5.73,8.15,4.76.47-.13.38-.86-.12-.86-3.07.01-5.96-1.09-7.21-4.13-.21-.5-1.02-.3-.83.23h0Z"
          />
          <path
            className="fill-[#4a2d2d]"
            d="M37.16,65.06c1.69,2.41,4.32,5.06,7.44,5.3.42.03.57-.59.21-.78-1.18-.63-2.45-1.03-3.58-1.77-1.28-.84-2.46-1.9-3.33-3.17-.31-.45-1.05-.02-.73.43h0Z"
          />
          <path
            className="fill-[#4a2d2d]"
            d="M44.39,57.65c1.45,2.54,4.6,5.12,7.73,4.48.36-.07.33-.61,0-.7-1.34-.37-2.62-.5-3.86-1.19s-2.36-1.77-3.1-3.04c-.29-.49-1.05-.05-.77.45h0Z"
          />
          <path
            className="fill-[#4a2d2d]"
            d="M52.25,50.57c1.42,2.4,4.01,4.37,6.89,4.4.45,0,.55-.68.11-.79-2.6-.63-4.79-1.71-6.25-4.05-.3-.48-1.04-.04-.75.44h0Z"
          />
          <path
            className="fill-[#4a2d2d]"
            d="M25.02,83.5c1.2,1.44,3.3,2.03,4.99,1.1.35-.19.11-.74-.27-.64-1.51.38-3.05.12-4.13-1.05-.37-.4-.93.18-.59.59h0Z"
          />
        </g>
