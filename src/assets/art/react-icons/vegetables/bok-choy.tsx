...
export const BokChoyIcon = (props: React.SVGProps<SVGSVGElement>) => (
  <svg
    id="Capa_2"
    data-name="Capa 2"
        ...
        <g>
          <g>
            <path
              ...
              d="M90.52,43.22c-.61-3.67-.79-7.77-.17-12.75.61-4.98.17-8.82-3.67-10.39-3.84-1.57-5.59,0-8.82,1.75-3.23,1.75-3.84.87-9.08,3.14-.66.28-1.25.74-1.78,1.26-1.56-2.99-3.65-4.3-4.77-5.8-1.31-1.75-.26-9.08-2.62-13.01s-6.2-4.1-10.13-2.62-3.41,4.63-5.41,6.64c-2.01,2.01-4.28,2.1-5.5,4.72-1.22,2.62-.09,6.72.7,11.18.3,1.69.12,3.26-.22,4.55-1.47-2.17-2.36-4.88-3.01-8.13-.79-3.93-5.59-10.74-13.54-9.17-7.95,1.57-12.49,9.34-10.13,19.56,2.36,10.22,12.05,13.71,12.49,16.07s-1.66,6.72.26,10.04c1.92,3.32,6.64,3.93,9,7.42,2.36,3.49,1.83,10.48,1.83,10.48l10.19-2.45c1.44,1.86,2.95,3.3,4.31,3.76,2.12.72,4.48.34,6.62-.74,2.1,1.97,5.03,3.42,8.32,3.8,5.33.61,10.22-3.58,10.39-5.15.17-1.57-3.41-6.9-2.53-11.35.87-4.45,3.23-8.03,8.65-11.96,5.41-3.93,9.26-7.16,8.65-10.83Z"
            />
            <path
              className="fill-white"
              d="M35.26,51.48c1.21-2.61,1.68-5.86,2.29-8.67.5-2.28.92-4.78-.13-6.96-.18-.37-.68-.09-.62.26.49,2.88.16,5.33-.52,8.15-.55,2.29-1.43,4.72-1.53,7.08-.01.26.39.39.51.14h0Z"
            />
            <path
              className="fill-white"
              d="M31.83,40.87c-2.19-.83-4.39-1.64-6.56-2.52s-4.82-1.51-5.97-3.62c-.18-.33-.66-.1-.58.25.45,2.07,2.73,2.81,4.48,3.54,2.76,1.16,5.57,2.21,8.44,3.08.48.14.65-.56.2-.73h0Z"
            />
            <path
              className="fill-white"
              d="M29.76,35.03c.72-2.87.83-6-.28-8.79-.15-.39-.69-.24-.62.17.44,2.88.68,5.51.12,8.4-.1.51.66.73.79.22h0Z"
            />
            <path
              className="fill-white"
              d="M54.04,51.01c3.34-4.4,7.84-10.33,6.6-16.24-.08-.39-.64-.27-.66.09-.21,3.22-.83,6-2.35,8.87-1.26,2.39-2.84,4.59-4.23,6.9-.26.43.37.76.65.38h0Z"
            />
            <path
              className="fill-white"
              d="M52.1,39.65c-1.97-1.83-3.87-3.55-5.37-5.82s-2.41-4.67-3.27-7.23c-.1-.3-.63-.27-.59.08.66,5.2,4.22,10.91,8.83,13.5.33.18.7-.26.41-.53h0Z"
            />
            <path
              className="fill-white"
              d="M52.67,28c1.34-1.7,2.6-3.54,3.45-5.54.13-.31-.26-.56-.46-.27-1.2,1.78-2.31,3.62-3.55,5.38-.23.32.31.75.56.43h0Z"
            />
            <path
              className="fill-white"
              d="M69.01,60.81c-.79-2.11-1.57-4.18-2.03-6.4-.45-2.21-.44-4.45-.81-6.65-.05-.32-.61-.33-.66,0-.61,4.31.83,9.53,2.83,13.33.19.36.82.11.67-.28h0Z"
            />
            <path
              className="fill-white"
              d="M75.48,44.61c-.46-2.47-1.03-4.88-1.11-7.41-.07-2.35.27-4.66.31-7,0-.35-.52-.42-.6-.08-1.21,4.63-.98,10.21.73,14.68.16.42.76.26.68-.19h0Z"
            />
            <path
              className="fill-white"
              d="M72.28,54.07c4.47-2.29,9.52-5.54,12.29-9.85.21-.32-.24-.62-.5-.39-1.88,1.64-3.58,3.46-5.53,5.02-2.1,1.67-4.36,3.15-6.69,4.47-.49.27-.06.99.43.74h0Z"
            />
            <path
              className="fill-[#f4f5d8]"
